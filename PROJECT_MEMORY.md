...
- Every generated version records the exact template id, template version, language, output family, and checksum, so a later template change can never re-explain an already generated file.
