...
- Current executable goal: integrate latest `main` into Issue #35 PR #40 on branch `feat/document-management`, preserve both merged task-management and document-management behavior, revalidate the combined system, and keep PR #40 open/unmerged for final review.
