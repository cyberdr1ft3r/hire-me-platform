...
- Current executable goal: keep Issue #35 draft PR #40 on branch `feat/document-management` open for human review after the final blocking-follow-up corrections and exact-head CI validation. Issue #35 incorporates Issue #12 and does not depend on unmerged Issue #31 / PR #32.
