...
- Every Issue #71 repository gate and the exact-head GitHub Actions run are green.
- The Issue #71 draft PR links the issue and records the implemented/deferred discovery matrix.
- Issue #66 records `D-REPORT-01 — IMPLEMENTED / AWAITING CHATGPT REVIEW` only after exact-head CI passes.
