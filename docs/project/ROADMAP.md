...
- Issue #64 begins the application-wide rollout with a bilingual Task Pipeline, corrected under drift audit Issue #66 into a lightweight status board with name-based people and record selectors. It preserves task domain semantics, adds only a narrowly scoped people lookup, a visible-task filter-only people lookup, and a self-only created-by-me list filter, and does not begin Clients or Missions.
- Drift audit Issue #66 (high priority) re-audits each completed surface before the rollout continues: Task merged through PR #65; Candidate D-CAND-01 through D-CAND-03 through PRs #68/#70; Reporting D-REPORT-01 through PR #72; public salary D-PUBLIC-01 through PR #74 (D-066 Accepted; historical salaries review-only). Public Opportunity audit #75 recorded eight runtime findings; **A-75-04** (PR #79), **A-75-02** (PR #81), **A-75-01** (PR #83, D-067), and **A-75-03** (PR #85, D-068, application level), **A-75-05** (PR #87, D-069), and **A-75-06/07** (PR #89, D-070; migration not run in production) are corrected on `main` at `fa2e594b4da68379ae2c1310a8c879ccc94f0639`. **A-75-08** is in review through Issue #90 under accepted D-071, and fresh EN/FR browser visual evidence and production D-068 proxy/env verification are still required. Merge the Issue #90 PR after final review, capture the responsive evidence, then audit AppShell/i18n and complete the remaining Clients/Missions/Training/Commercial UX rollout. After the functional rollout, perform the whole-product UI-DNA v1.1 visual identity audit (D-DESIGN-01), still deferred.
