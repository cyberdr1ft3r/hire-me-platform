...
Candidate compensation and consent fields require their dedicated permissions even when ordinary candidate permissions are present. Frontend hiding is only a usability layer; the API enforces this rule.
