...
const permissions = [
  ...
  {
    code: 'training_programs:view',
    description: 'View training programs within the assigned training scope.',
    scopeType: PermissionScopeType.ASSIGNED,
  },
  {
    code: 'training_programs:view_all',
    description: 'Broad training oversight across all internal training programs.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'training_programs:manage',
    description: 'Create and update training programs within the authorized scope.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'training_programs:status:manage',
    description: 'Apply approved training program lifecycle transitions.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'training_programs:archive',
    description: 'Archive closed training programs without deleting training history.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'training_sessions:view',
    description: 'View training sessions within the authorized training program scope.',
    scopeType: PermissionScopeType.ASSIGNED,
  },
  {
    code: 'training_sessions:manage',
    description: 'Schedule, update, reschedule, cancel, and transition training sessions.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'training_sessions:archive',
    description: 'Archive completed or canceled training sessions.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'training_enrollments:view',
    description: 'View training enrollments within the authorized training program scope.',
    scopeType: PermissionScopeType.ASSIGNED,
  },
  {
    code: 'training_participation:view',
    description: 'View training session participation and attendance records.',
    scopeType: PermissionScopeType.ASSIGNED,
  },
  {
    code: 'training_participation:manage',
    description: 'Record training session participation and attendance.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'training_participation:correct',
    description: 'Apply audited corrections to already-recorded training attendance.',
    scopeType: PermissionScopeType.EXPLICIT,
  },
  {
    code: 'missions:view',
