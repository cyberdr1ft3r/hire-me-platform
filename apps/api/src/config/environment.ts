import { apiDefaultJsonBodyLimit, publicApplicationDefaultJsonBodyLimit } from '@hire-me/contracts';
import { z } from 'zod';
...
const EnvironmentSchema = z.object({
  ...
  JSON_BODY_LIMIT: z.string().min(1).default(apiDefaultJsonBodyLimit),
