...
export const frMessages: Messages = {
  ...
  task: {
    actions: {
      ...
      addReminder: 'Programmer le rappel',
      applyFilters: 'Appliquer les filtres',
      archive: 'Archiver la tâche',
      archiveNotification: 'Archiver',
      cancel: 'Annuler',
      changeOwner: 'Changer de responsable',
      close: 'Fermer le détail de la tâche',
      ...
      processReminders: 'Envoyer maintenant les rappels échus',
      reset: 'Réinitialiser les filtres',
      retry: 'Réessayer',
      save: 'Enregistrer les modifications',
    },
    board: {
      ...
      columnEmpty: 'Aucune tâche ici.',
      columnError: 'Impossible de charger cette colonne.',
      loadMoreFailed: 'Impossible de charger plus de tâches.',
      region: 'Tableau des tâches',
      showing: '{shown} sur {total} affichées',
      switcher: 'Colonnes du tableau',
    },
    card: {
      noAssignee: 'Aucune personne assignée',
      assignedToYou: 'Vous est assignée',
      assignees: plural({
        many: '{count} de personnes assignées',
        one: '{count} personne assignée',
    ...
    context: {
      fields: {
        ...
        clientContactId: 'Contact client',
        clientId: 'Client',
        documentId: 'Document',
        interviewId: 'Entretien',
        missionCandidateId: 'Candidat de la mission',
        missionPlacementId: 'Placement',
        missionRecruiterId: 'Recruteur de la mission',
        recruitmentMissionId: 'Mission',
        recruitmentOfferId: 'Offre',
        recruitmentOfferVersionId: 'Version de l’offre',
        trainingEnrollmentId: 'Inscription à la formation',
        trainingProgramId: 'Programme de formation',
        trainingSessionId: 'Session de formation',
        trainingSessionParticipationId: 'Participation à la session',
      },
      kind: 'Type d’élément lié',
      kinds: {
        candidate: 'Candidat',
        client: 'Client',
        document: 'Document',
      ...
      record: 'Élément lié',
      title: 'Éléments liés',
      unavailable: 'Détails non disponibles avec vos accès.',
    },
    detail: {
      ...
      dueAt: 'Échéance',
      noAssignees: 'Personne n’est encore assigné',
      noDescription: 'Aucune description.',
      notRecorded: 'Non renseigné',
      owner: 'Responsable',
      people: 'Responsable et personnes assignées',
      updated: 'Dernière mise à jour',
      workflow: 'Avancement',
    },
    diagnostics: {
      description:
        'Les rappels sont envoyés par lots. Aucun planificateur automatique n’est encore configuré : un responsable peut lancer l’envoi ici.',
    ...
    fields: {
      ...
      description: 'Description',
      due: 'Échéance',
      dueAt: 'Date et heure d’échéance',
      dueFrom: 'Échéance à partir du',
    ...
    filters: {
      anyDue: 'Toute échéance',
      anyPriority: 'Toute priorité',
      anyRecord: 'Tout élément',
      ...
      sort: {
        dueAt: 'Échéance, la plus proche d’abord',
        priority: 'Priorité, la plus haute d’abord',
        updatedAt: 'Mises à jour récemment',
      },
    },
    header: {
      description:
        'Faites avancer le travail d’étape en étape, repérez les échéances et ouvrez une tâche pour en voir le détail.',
      title: 'Pipeline des tâches',
    },
    list: {
      empty: 'Aucune tâche visible.',
      filteredEmpty: 'Aucune tâche ne correspond à ces filtres.',
      page: 'Page {page} sur {pages}',
      pagination: 'Pages de la liste des tâches',
    ...
    notifications: {
      ...
      title: 'Notifications',
      types: {
        assigned: { body: 'Une tâche vous a été assignée.', title: 'Tâche assignée' },
        mentioned: {
          body: 'Vous avez été mentionné dans un commentaire de tâche.',
          title: 'Mention dans une tâche',
        },
        overdue: { body: 'Une tâche est en retard.', title: 'Tâche en retard' },
        ownerChanged: {
          body: 'Vous êtes désormais responsable d’une tâche.',
    ...
    picker: {
      ...
      searchPeopleHint: 'Nom ou adresse e-mail',
      searchRecordsHint: 'Nom ou intitulé',
      you: '{name} (vous)',
    },
    reminders: {
    ...
    states: {
      detailError: 'Impossible de charger cette tâche.',
      listError: 'Impossible de charger les tâches.',
      loadingDetail: 'Chargement du détail de la tâche…',
      loadingList: 'Chargement des tâches…',
    },
    validation: {
      assigneeRequired: 'Pour démarrer le travail, au moins une personne doit être assignée.',
      reasonRequired: 'Un motif est obligatoire pour ce déplacement.',
      required: 'Ce champ est obligatoire.',
    },
    values: {
      dueFuture: 'Échéance le {date}',
      dueNone: 'Pas d’échéance',
      dueOverdue: 'En retard · {date}',
      dueToday: 'Échéance aujourd’hui · {date}',
    },
    views: {
      board: 'Tableau',
      label: 'Disposition',
  ...
  preview: {
    ...
    task: {
      dataset: 'Jeu de données de prévisualisation',
      empty: 'Espace de travail vide',
      filtered: 'Résultat filtré vide',
      noTask: 'Aucune',
      openTask: 'Tâche ouverte',
      populated: 'Tâches représentatives',
    },
