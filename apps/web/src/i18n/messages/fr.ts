...
export const frMessages: Messages = {
  ...
  task: {
    actions: {
      ...
      markAllRead: 'Marquer les visibles comme lues',
      markRead: 'Marquer comme lue',
      newTask: 'Nouvelle tâche',
      processReminders: 'Traiter les rappels échus',
      reset: 'Réinitialiser',
      retry: 'Réessayer',
      save: 'Enregistrer',
    ...
    comments: {
      ...
      mentions: 'UUID des utilisateurs mentionnés',
      mentionsHint: 'Séparez plusieurs UUID par des virgules.',
      title: 'Commentaires',
    },
    detail: {
      assignments: 'Responsables',
      context: 'Contexte lié',
      created: 'Créée',
      description: 'Description',
      history: 'Historique d’activité',
      metadata: 'Détails de la tâche',
      notRecorded: 'Non renseigné',
      selectBody: 'Choisissez une tâche dans la file pour afficher son détail opérationnel.',
      selectTitle: 'Sélectionnez une tâche',
      updated: 'Dernière mise à jour',
    },
    feedback: {
      archived: 'Tâche archivée.',
      assignmentAdded: 'Responsable ajouté.',
      commentAdded: 'Commentaire ajouté.',
      created: 'Tâche créée.',
      errorTitle: 'Échec de l’action',
      failed: 'L’action n’a pas pu aboutir. Vérifiez la tâche puis réessayez.',
      ownerChanged: 'Propriétaire de la tâche modifié.',
    ...
    fields: {
      assignee: 'UUID de l’utilisateur responsable',
      description: 'Description',
      dueAt: 'Date et heure d’échéance',
      missionCandidate: 'UUID du candidat de mission',
      mission: 'UUID de la mission',
      owner: 'UUID de l’utilisateur propriétaire',
      priority: 'Priorité',
      reason: 'Motif',
    ...
    filters: {
      ...
      anyStatus: 'Tous les statuts',
      description: 'Recherchez et affinez la file de travail actuelle.',
      title: 'Filtres de la file',
    },
    header: {
      description:
        'Suivez les responsabilités, échéances, statuts, commentaires et rappels dans une seule file.',
      title: 'Pipeline des tâches',
    },
    list: {
      assignees: plural({ one: '{count} responsable', other: '{count} responsables' }),
      empty: 'Aucune tâche visible.',
      filteredEmpty: 'Aucune tâche ne correspond à ces filtres.',
      region: 'File des tâches',
    ...
    reminders: {
      ...
      recipient: 'UUID de l’utilisateur destinataire',
    ...
    states: {
      ...
      loadingDetail: 'Chargement des détails de la tâche…',
      loadingList: 'Chargement des tâches…',
    },
    validation: {
      reasonRequired: 'Un motif est requis pour ce statut.',
      required: 'Ce champ est obligatoire.',
    },
    values: {
      dueFuture: 'Échéance : {date}',
      dueNone: 'Aucune échéance',
